<template>
  <div class="wrap m_wrap" :class="{ dark: this.color }">
    ...
    <div class="main_sub">
      ...
      <div class="menu01">
        <strong desc="메뉴관리">{{ GetMainLanguage.hamburger.menu.menuset }}</strong>
        ...
        <div class="editmenu" v-else>
          ...
          <ul class="clfix">
            ...
            <li>
              ...
              <em>{{ GetMainLanguage.hamburger.menu.add }}</em>
            </li>
          </ul>
        </div>
      </div>
      <div class="menu02">
        <strong desc="포틀릿 서비스">{{ GetMainLanguage.hamburger.menu.portlet }}</strong>
      ...
      <div class="menu03">
        <strong desc="포틀릿 순서변경">{{ GetMainLanguage.hamburger.menu.portletposition }}</strong>
    ...
    <div class="main_tabmenu">
      <ul class="main_menu clfix">{{this.Category}}
        <li :class="[{ active: Category === 'my' },{ tab: Category === 'my' }]">
          <router-link to="my">MY</router-link>
        </li>
        <li
          :class="[{ active: Category === value.key },{ tab: Category === value.key }]"
    ...
    <ul class="quick">
      <li>
        <a href="../mobile/mob_main.html">{{
          GetMainLanguage.footer.ktop_home
        }}</a>
      </li>
      <li>
        <a href="">{{ GetMainLanguage.footer.saerom_home }}</a>
      </li>
      <li>
        <a href="">{{ GetMainLanguage.footer.talk_install }}</a>
      </li>
      <li>
        <a href="">{{ GetMainLanguage.footer.logout }}</a>
      </li>
    </ul>
...
export default {
  ...
  computed: {
    // ...mapState(["systemcolor"]),
    ...mapGetters(["GetMyInfo","GetMainLanguage","GetConfig","GetSystemColor"]),
  ...
  methods: {
    ...
    deleteItem: function (item, index) {
      // console.log(this.GetConfig.main.menuportlet,"전")
      this.menuposition.splice(index, 1);
      // console.log(this.GetConfig.main.menuportlet,"후")
    },
    // 메뉴관리 초기화
    resetItem() {
      let menuportlet = [];
    ...
    checkService(value, index) {
      this.GetConfig.main.portlet[index].service = !this.GetConfig.main.portlet[index]
        .service;
      this.$store.dispatch("setConfig", {
        menu: "main",
        value: this.GetConfig.main.portlet,
