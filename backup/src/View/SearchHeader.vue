  ...
  <div class="search_bar">
    <div>
      <form @submit.prevent="signInButtonPressed">
        <input
          type="text"
          class="search"
          :placeholder="this.language.search.inputbox"
    ...
    <div id="recommend">
      ...
      <div class="recent_search">
        ...
        <p>
          <em @click="AllDel()">{{ language.search.delete }}</em>
          <em class="end">{{ language.search.completion }}</em>
        </p>
      </div>
    </div>
  </div>
...
export default {
  computed: {
    ...mapState(["autoList", "data", "recent", "form", "config", "language"]),
    copyRecent(){
