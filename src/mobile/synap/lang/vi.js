(function () {
    var messages = {
        ...
        "message.alert.xfdCol": "Cột tài liệu được mở rộng tối đa (XFD). <br> Để chỉnh sửa trơn tru, chỉ định phần cuối của khu vực là Z100. <br> Đặt lại khu vực nếu cần thiết",
