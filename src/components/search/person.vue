        ...
        <ul v-if="datacheck">
          <li v-for="(value, name) in this.sortdata[path].data" :key="name">
            <a href="">
              ...
              <ul>
                <li><span>{{GetSearchLanguage[path].dept}} : </span>{{ value.dept }}</li>
                <li><span>{{GetSearchLanguage[path].position}} : </span>{{ value.jobposition }}</li>
                <li><span>{{GetSearchLanguage[path].tel}} : </span>{{ value.companytel }}</li>
                <li><span>{{GetSearchLanguage[path].phone}} : </span>{{ value.phone }}</li>
                <li><span>{{GetSearchLanguage[path].email}} : </span>{{ value.email }}</li>
                <li><span>{{GetSearchLanguage[path].work}} : </span>{{ value.job }}</li>
              </ul>
            </a>
          </li>
