      ...
      children: [
        {
          ...
          name: "MyIcon",
          beforeEnter: (to, from, next) => {
            store.dispatch("calendar/GetSchedule", { scheduletype: "recent", category: "my" });
      ...
      children: [
        {
          ...
          beforeEnter: (to, from, next) => {
            ...
            store.dispatch("search/SearchWord", {
              category: to.path.substring(to.path.lastIndexOf("/") + 1)
            })
              .then(() => {
                next();
        ...
        },
        {
          ...
          beforeEnter: (to, from, next) => {
            if (to.params.unid) {
              ...
              store.dispatch("mailjs/MailDetail", store.state.store.maildetail.unid);
              next();
            }
            // 
          },
        },
        {
          ...
          beforeEnter: (to, from, next) => {
            ...
            if (store.state.from == "Reply") {
              store.commit("mailjs/MailOrgData", store.state.store.maildetail.author);
        ...
        },
        {
          ...
          beforeEnter: (to, from, next) => {
            ...
            if (to.params.unid) {
              ...
              // store.commit("DisBeforeSave");
              store.dispatch("mailjs/GreetDetail", { unid: store.state.store.mailconfig.view.greetDetailUnid });
              next();
            }
          },
        },
        {
          ...
          beforeEnter: (to, from, next) => {
            if (to.params.unid) {
              ...
              store.dispatch("mailjs/SignDetail", { unid: store.state.store.mailconfig.view.signDetailUnid });
              // store.commit("DisBeforeSave");
              next();
            }
          },
      ...
      children: [
        ...
        },
        {
          ...
          beforeEnter: (to, from, next) => {
            ...
            store.dispatch("mailjs/CalDetail",{data,path:"",which})
              .then(() => {
                next();
              })
          },
      ...
      children: [
        {
          ...
          beforeEnter: (to, from, next) => {
            store.dispatch("appro/GetApprovalList", { type: "draft" })
            // .then(() => {
            next();
            // })
          },
        ...
        },
        {
          ...
          component: appTodoList,
          beforeEnter: (to, from, next) => {
            store.dispatch("appro/GetApprovalList", { type: "approve" })
            // .then(() => {
            next();
            // })
          },
        },
        {
          ...
          component: appTodoList,
          beforeEnter: (to, from, next) => {
            store.dispatch("appro/GetApprovalList", { type: "reject" })
            // .then(() => {
            next();
            // })
          },
        },
        {
          ...
          component: appTodoList,
          beforeEnter: (to, from, next) => {
            store.dispatch("appro/GetApprovalList", { type: "success_date" })
            // .then(() => {
            next();
            // })
          },
        },
        {
          ...
          component: appTodoList,
          beforeEnter: (to, from, next) => {
            store.dispatch("appro/GetApprovalList", { type: "success_my" })
            // .then(() => {
            next();
            // })
          },
        },
        {
          ...
          component: appTodoList,
          beforeEnter: (to, from, next) => {
            store.dispatch("appro/GetApprovalList", { type: "success_dept" })
            // .then(() => {
            next();
            // })
          },
        },
        {
          ...
          beforeEnter: (to, from, next) => {
            store.dispatch("appro/GetApprovalList", { type: "approving" })
            // .then(() => {
            next();
            // })
          },
          ...
          beforeEnter: (to, from, next) => {
            store.dispatch("appro/DocApproval", { type: "formList_all" })
            store.dispatch("appro/DocApproval", { type: "formList_recent" })
            store.dispatch("appro/DocApproval", { type: "formList_favorite" })
            // .then(() => {
            next();
            // })
          },
